...
extension DKUser: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case id
        case name
        case userName       = "user_name" // Alternative name field
    ...
    public convenience init(from decoder: Decoder) throws {
        ...
        // Name field can change field title depending on serialization
//        if let nameString = try? container.decodeIfPresent(String.self, forKey: .name) {
//            self.name = nameString
//        } else if let nameString = try? container.decodeIfPresent(String.self, forKey: .userName) {
//            self.name = nameString
//        } else {
//            throw DKError.unableToSerializeJSON
//        }
